...
def build_army(player):
    ...
    building_builder.buy_building(player.building_factories[0])
    #print(player)
    root = Tk()
    ...
    #root.bind("<Button-2>", lambda event: update(player, money_label, army_builder.army.units, hired_armies, hired_units, buildings, builded_buildings))
    #root.bind("<Button-1>", lambda event: update(player, money_label, army_builder.army.units, hired_armies, hired_units, buildings, builded_buildings))
    #root.bind("<Motion>", lambda event: update(player, money_label, army_builder.army.units, hired_armies, hired_units, buildings, builded_buildings))
    ...
    root.mainloop()
    print(player)
    #for x in player.armies[index].units:
    #    x.move()
